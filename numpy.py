...
array = np.array([[4,6,18],[55,66,99]] , dtype=float ) #data type of multidimensional array object
...
array = np.arange(24).reshape(2,3,4) #this is a 3-dimensional array with 2 rows ,  column3s and 4 depth
...
print("\n values in array from index 1 to 5 : ",arrayone[1:6])

print("\nvalues in array from index 11 : ",arrayone[11:])

print("\nvalues in array from index start to 9 : ",arrayone[:10])
...
print("\n sum of coresponding elements of array : \n",arrayone+arraytwo) # in this the pairs are (4+2)(5+4)(7+1)(5+2)(2+4)(5+1)(9+2)(6+4)(3+1)
